import{s as y}from"./supabaseClient-BXT4n9qe.js";import{i as J,e as K,D as g,a as Q,p as Y,b as Z}from"./layout-Cb_Oe5x8.js";/* empty css               */import{g as V,u as ee,h as te,i as ae,j as re,k as oe,l as se,m as le}from"./dataService-BFNJnUJq.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2.39.0/+esm";let S="borrower",u=null,C=[],v={...g},n={...g},L=!1,k=!1,ne=!1,de=!1;const T=[{key:"primary_color",label:"Primary Color",description:"Used for CTAs, highlights and primary focus states."},{key:"secondary_color",label:"Secondary Color",description:"Used for gradients, hover states and charts."},{key:"tertiary_color",label:"Tertiary Color",description:"Used for gradients and subtle accents."}],ie=e=>{switch(e){case"super_admin":return"bg-purple-100 text-purple-700 border-purple-200";case"admin":return"bg-blue-100 text-blue-700 border-blue-200";case"base_admin":return"bg-orange-100 text-orange-700 border-orange-200";default:return"bg-green-50 text-green-700 border-green-200"}},$=e=>{switch(e){case"super_admin":return"SUPER ADMIN";case"admin":return"LOAN MANAGER";case"base_admin":return"LOAN OFFICER";default:return"CLIENT"}},X=(e,t={})=>{const{sizeClass:a="w-10 h-10",textClass:o="text-sm"}=t,r=e.full_name||"U";return e.avatar_url?`<img src="${e.avatar_url}" class="${a} rounded-full object-cover border border-gray-200 shadow-sm" alt="${r}">`:`
    <div class="${a} rounded-full bg-gray-100 border border-gray-200 flex items-center justify-center ${o} font-bold text-gray-600">
      ${r.charAt(0).toUpperCase()}
    </div>
  `},i=(e,t="success")=>{let a=document.getElementById("toast-container");a||(a=document.createElement("div"),a.id="toast-container",a.className="fixed bottom-6 right-6 z-[9999] flex flex-col gap-2 pointer-events-none",document.body.appendChild(a));const o=document.createElement("div"),r=t==="success"?"bg-gray-900 text-white":"bg-red-600 text-white",d=t==="success"?'<i class="fa-solid fa-check-circle"></i>':'<i class="fa-solid fa-circle-exclamation"></i>';o.className=`${r} px-4 py-3 rounded-lg shadow-xl flex items-center gap-3 transform transition-all duration-300 translate-y-4 opacity-0 min-w-[300px] pointer-events-auto`,o.innerHTML=`${d}<span class="font-medium text-sm">${e}</span>`,a.appendChild(o),requestAnimationFrame(()=>o.classList.remove("translate-y-4","opacity-0")),setTimeout(()=>{o.classList.add("opacity-0","translate-y-2"),setTimeout(()=>o.remove(),300)},3e3)},ce=(e=[])=>Array.isArray(e)?e.map((t={})=>({title:typeof t.title=="string"?t.title:"",text:typeof t.text=="string"?t.text:""})):[],M=e=>{const t=g.carousel_slides||[],a=ce(Array.isArray(e)&&e.length?e:t),o=t.length||3;for(;a.length<o;){const r=t[a.length]||{title:"",text:""};a.push({...r})}return a.slice(0,o).map((r,d)=>{var l,f,w,E;return{title:((l=r.title)==null?void 0:l.trim())||((f=t[d])==null?void 0:f.title)||"",text:((w=r.text)==null?void 0:w.trim())||((E=t[d])==null?void 0:E.text)||""}})},h=(e,t=!1)=>typeof e=="boolean"?e:typeof e=="string"?e.toLowerCase()==="true":t,x=e=>{if(!e)return null;let t=e.trim().replace("#","");return t.length===3&&(t=t.split("").map(a=>a+a).join("")),/^[0-9A-Fa-f]{6}$/.test(t)?`#${t.toUpperCase()}`:null},G=e=>(typeof e=="string"?e.trim():"")||g.company_name,b=(e={})=>({...g,...e,company_name:G(e==null?void 0:e.company_name),auth_overlay_color:x(e==null?void 0:e.auth_overlay_color)||g.auth_overlay_color,auth_overlay_enabled:h(e==null?void 0:e.auth_overlay_enabled,g.auth_overlay_enabled),auth_background_flip:h(e==null?void 0:e.auth_background_flip,g.auth_background_flip),carousel_slides:M(e.carousel_slides)}),U=()=>M(n==null?void 0:n.carousel_slides),O=(e="")=>(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;"),ue=(e="")=>(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),pe=()=>{T.forEach(({key:t})=>{const a=document.querySelector(`[data-color-picker="${t}"]`),o=document.querySelector(`[data-color-input="${t}"]`);a&&(a.value=n[t]),o&&(o.value=n[t])});const e=document.getElementById("brand-gradient-preview");e&&(e.style.backgroundImage=`linear-gradient(120deg, ${n.primary_color}, ${n.secondary_color}, ${n.tertiary_color})`),document.querySelectorAll("[data-theme-mode]").forEach(t=>{t.dataset.themeMode===n.theme_mode?(t.classList.add("bg-gray-900","text-white","shadow"),t.classList.remove("text-gray-600","bg-white")):(t.classList.remove("bg-gray-900","text-white","shadow"),t.classList.add("text-gray-600","bg-white"))}),ye(),fe(),xe(),ve(),B()},B=()=>{const e=document.getElementById("save-system-settings"),t=document.getElementById("system-settings-status");e&&(e.disabled=!L||k,e.innerHTML=k?'<i class="fa-solid fa-circle-notch fa-spin mr-2"></i>Saving':"Save Changes"),t&&(t.textContent=L?"Unsaved changes":"Theme saved",t.className=L?"text-xs text-orange-600 font-bold":"text-xs text-green-600 font-bold")},ge=()=>{L=!0,B()},p=e=>{const t={...e};e.carousel_slides&&(t.carousel_slides=M(e.carousel_slides)),n=b({...n,...t}),ge(),Z(n),pe()},me=()=>(n.company_logo_url||"").trim(),be=()=>(n.auth_background_url||"").trim(),ye=()=>{const e=me(),t=document.getElementById("company-logo-preview"),a=document.getElementById("company-logo-empty"),o=document.getElementById("remove-logo-btn"),r=document.getElementById("logo-url-input");t&&(e?(t.src=e,t.classList.remove("hidden"),a&&a.classList.add("hidden")):(t.src="",t.classList.add("hidden"),a&&a.classList.remove("hidden"))),o&&(o.disabled=!e||ne),r&&document.activeElement!==r&&(r.value=e)},fe=()=>{const e=be(),t=h(n.auth_background_flip,!1),a=document.getElementById("auth-bg-preview"),o=document.getElementById("auth-bg-empty"),r=document.getElementById("wallpaper-flip-toggle"),d=document.getElementById("remove-wallpaper-btn"),l=document.getElementById("wallpaper-url-input");a&&(a.style.backgroundImage=e?`url('${e}')`:"none",a.style.transform=t?"scaleX(-1)":"scaleX(1)",o&&o.classList.toggle("hidden",!!e)),r&&(r.checked=t),d&&(d.disabled=!e||de),l&&document.activeElement!==l&&(l.value=e)},xe=()=>{const e=x(n.auth_overlay_color)||g.auth_overlay_color,t=h(n.auth_overlay_enabled,!0),a=document.getElementById("overlay-color-picker"),o=document.getElementById("overlay-color-input"),r=document.getElementById("overlay-disable-toggle");a&&(a.value=e),o&&(o.value=e),r&&(r.checked=!t)},ve=()=>{U().forEach((t,a)=>{const o=document.querySelector(`[data-carousel-field="title"][data-carousel-index="${a}"]`),r=document.querySelector(`[data-carousel-field="text"][data-carousel-index="${a}"]`);o&&o!==document.activeElement&&(o.value=t.title),r&&r!==document.activeElement&&(r.value=t.text)})};function he(){const e=document.getElementById("main-content");if(!e)return;e.innerHTML=`
  ...
  `,document.head.appendChild(t),we(),A()}function we(){const e=document.querySelectorAll(".tab-btn");e.forEach(a=>{a.onclick=()=>{e.forEach(r=>r.classList.remove("active")),a.classList.add("active");const o=a.dataset.tab;o==="profile"?A():o==="security"?Ee():o==="users"?W():o==="billing"?_e():o==="system"&&Ie()}});const t=document.getElementById("role-form");t&&t.addEventListener("submit",async a=>{a.preventDefault();const o=document.getElementById("modal-user-id").value,r=document.getElementById("modal-role-select").value;try{const{error:d}=await ee(o,r);if(d)throw new Error(d);i("Role updated successfully","success"),document.getElementById("role-modal").classList.add("hidden"),W()}catch(d){i(d.message,"error")}})}function A(){const e=document.getElementById("tab-content");e.innerHTML=`
    ...
    `,document.getElementById("profile-form").addEventListener("submit",async t=>{t.preventDefault();const a=document.getElementById("save-profile"),o=a.innerHTML;a.disabled=!0,a.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{const r={full_name:document.getElementById("prof-name").value,contact_number:document.getElementById("prof-phone").value},{error:d}=await te(r);if(d)throw new Error(d);u={...u,...r},i("Profile Updated","success")}catch(r){i(r.message,"error")}finally{a.disabled=!1,a.innerHTML=o}}),document.getElementById("avatar-input").addEventListener("change",async t=>{const a=t.target.files[0];if(a){document.getElementById("avatar-spinner").classList.remove("hidden");try{const o=a.name.split(".").pop(),r=`${u.id}/${Date.now()}.${o}`,{error:d}=await y.storage.from("avatars").upload(r,a,{upsert:!0});if(d)throw d;const{data:l}=y.storage.from("avatars").getPublicUrl(r);await ae(l.publicUrl),u.avatar_url=l.publicUrl,A(),i("Avatar updated","success")}catch(o){i("Failed to upload: "+o.message,"error")}finally{}}})}function Ee(){const e=document.getElementById("tab-content");e.innerHTML=`
        <div class="max-w-2xl animate-fade-in">
    ...
    `,document.getElementById("security-form").addEventListener("submit",async t=>{t.preventDefault();const a=document.getElementById("sec-pass").value,o=document.getElementById("sec-confirm").value;if(a!==o)return i("Passwords do not match","error");if(a.length<6)return i("Password too short (min 6 chars)","error");const{error:r}=await y.auth.updateUser({password:a});r?i(r.message,"error"):(i("Password updated successfully","success"),t.target.reset())})}async function W(){const e=document.getElementById("tab-content");if(e){e.innerHTML=`
  ...
  `;try{const t=await re();C=Array.isArray(t)?t:[];const a=o=>{const r=document.getElementById("user-management-list"),d=document.getElementById("user-count");if(d&&(d.textContent=`Showing ${o.length} users`),o.length===0){r.innerHTML='<tr><td colspan="4" class="p-8 text-center text-sm text-gray-500">No users found.</td></tr>';return}r.innerHTML=o.map(l=>{const f=(u==null?void 0:u.id)===l.id;return`
              <tr class="hover:bg-gray-50 transition-colors group">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-right">
                      ${f?'<span class="text-xs text-gray-400 italic">Current User</span>':`
            ...
            `}).join(""),r.querySelectorAll(".change-role-btn").forEach(l=>{l.onclick=()=>{document.getElementById("modal-user-id").value=l.dataset.userId,document.getElementById("modal-user-name").textContent=l.dataset.userName,document.getElementById("modal-current-role").textContent=$(l.dataset.userRole),document.getElementById("modal-role-select").value=l.dataset.userRole,document.getElementById("role-modal").classList.remove("hidden")}})};a(C),document.getElementById("user-search").addEventListener("input",o=>{const r=o.target.value.toLowerCase(),d=C.filter(l=>(l.full_name||"").toLowerCase().includes(r)||(l.email||"").toLowerCase().includes(r)||(l.id||"").toLowerCase().includes(r));a(d)})}catch(t){console.error(t),document.getElementById("user-management-list").innerHTML=`<tr><td colspan="4" class="p-8 text-center text-red-600">Error: ${t.message}</td></tr>`}}}window.openRoleModal=(e,t,a)=>{document.getElementById("modal-user-id").value=e,document.getElementById("modal-user-name").textContent=t,document.getElementById("modal-current-role").textContent=$(a),document.getElementById("modal-role-select").value=a,document.getElementById("role-modal").classList.remove("hidden")};async function _e(){const e=document.getElementById("tab-content");e.innerHTML=`
    ...
    `;const t=async()=>{const{data:a}=await le(),o=document.getElementById("cards-list");if(!a||a.length===0){o.innerHTML='<p class="text-sm text-gray-400 italic">No cards saved.</p>';return}o.innerHTML=a.map(r=>`
        ...
        `).join("")};t(),document.getElementById("card-form").addEventListener("submit",async a=>{a.preventDefault();const o={p_card_type:document.getElementById("card-type").value,p_last_four:document.getElementById("card-last4").value,p_expiry_month:document.getElementById("card-mm").value,p_expiry_year:document.getElementById("card-yy").value},{error:r}=await oe(o);r?i(r.message,"error"):(i("Card Added","success"),a.target.reset(),t())})}async function Ie(){var w,E,P,D,F,H,N,j,R,z,q;const e=document.getElementById("tab-content");if(!e)return;try{const{data:s}=await V();s&&(v=b(s),n=b(s))}catch(s){console.error("Settings Sync Error:",s)}const t=n.company_logo_url||"",a=n.auth_background_url||"",o=O(G(n.company_name)),r=x(n.auth_overlay_color)||g.auth_overlay_color,d=!h(n.auth_overlay_enabled,!0),l=h(n.auth_background_flip,!1),f=U();e.innerHTML=`
            ...
            <section class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input type="text" id="company-name-input" value="${o}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-orange-500 focus:border-orange-500">
                    </div>
                    <div>
    ...
    `,T.forEach(({key:s})=>{var c,_;(c=document.querySelector(`[data-color-picker="${s}"]`))==null||c.addEventListener("input",I=>{const m=x(I.target.value);m&&p({[s]:m})}),(_=document.querySelector(`[data-color-input="${s}"]`))==null||_.addEventListener("change",I=>{const m=x(I.target.value);m&&p({[s]:m})})}),(w=document.getElementById("company-name-input"))==null||w.addEventListener("input",s=>p({company_name:s.target.value})),(E=document.getElementById("wallpaper-flip-toggle"))==null||E.addEventListener("change",s=>p({auth_background_flip:s.target.checked})),(P=document.getElementById("overlay-disable-toggle"))==null||P.addEventListener("change",s=>p({auth_overlay_enabled:!s.target.checked})),(D=document.getElementById("overlay-color-picker"))==null||D.addEventListener("input",s=>{const c=x(s.target.value);c&&p({auth_overlay_color:c})}),document.querySelectorAll("[data-carousel-field]").forEach(s=>{s.addEventListener("input",c=>{const _=parseInt(c.target.dataset.carouselIndex),I=c.target.dataset.carouselField,m=[...U()];m[_]={...m[_],[I]:c.target.value},p({carousel_slides:m})})}),(F=document.getElementById("save-system-settings"))==null||F.addEventListener("click",async()=>{if(k)return;k=!0,B();const{data:s,error:c}=await se(n);c?i("Failed to save: "+c,"error"):(i("System settings saved!","success"),v=b(s),n=b(s),L=!1,Y(v)),k=!1,B()}),(H=document.getElementById("logo-file-input"))==null||H.addEventListener("change",Le),(N=document.getElementById("remove-logo-btn"))==null||N.addEventListener("click",()=>{p({company_logo_url:null}),i("Logo removed (pending save).","success")}),(j=document.getElementById("apply-logo-url"))==null||j.addEventListener("click",()=>{const s=document.getElementById("logo-url-input").value.trim();s&&(p({company_logo_url:s}),i("Logo link applied. Save to confirm.","success"))}),(R=document.getElementById("wallpaper-file-input"))==null||R.addEventListener("change",ke),(z=document.getElementById("remove-wallpaper-btn"))==null||z.addEventListener("click",()=>{p({auth_background_url:null}),i("Wallpaper removed (pending save).","success")}),(q=document.getElementById("apply-wallpaper-url"))==null||q.addEventListener("click",()=>{const s=document.getElementById("wallpaper-url-input").value.trim();s&&(p({auth_background_url:s}),i("Wallpaper link applied. Save to confirm.","success"))}),B()}async function Le(e){const t=e.target.files[0];if(t)try{const a=t.name.split(".").pop(),o=`system/logo_${Date.now()}.${a}`,{error:r}=await y.storage.from("avatars").upload(o,t);if(r)throw r;const{data:d}=y.storage.from("avatars").getPublicUrl(o);p({company_logo_url:d.publicUrl}),i("Logo uploaded successfully!","success")}catch(a){i("Upload failed: "+a.message,"error")}}async function ke(e){const t=e.target.files[0];if(t)try{const a=t.name.split(".").pop(),o=`system/wallpaper_${Date.now()}.${a}`,{error:r}=await y.storage.from("avatars").upload(o,t);if(r)throw r;const{data:d}=y.storage.from("avatars").getPublicUrl(o);p({auth_background_url:d.publicUrl}),i("Wallpaper uploaded successfully!","success")}catch(a){i("Upload failed: "+a.message,"error")}}async function Be(){try{const{data:e}=await V();e&&(v=b(e),n=b(e),Y(v))}catch(e){console.error("Init Settings Error:",e)}}document.addEventListener("DOMContentLoaded",async()=>{const e=await J();if(e){if(S=e.role,u=e.profile,S==="super_admin")await Be();else{await K();const t=Q();if(t){const a=b(t);v=a,n=b(a)}}he()}});
